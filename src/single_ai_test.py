...
def single_ai_test():
    ...
    stats_greedy = run_multiple_games(
        num_games=1000, ai_func=get_ai_move_greedy, verbose=False
    )
    print_stats(stats_greedy)

    stats_advanced = run_multiple_games(
        num_games=1000, ai_func=get_ai_move_advanced, verbose=False
    )
    ...
    stats_mcts = run_multiple_games(
        num_games=100, ai_func=get_ai_move_mcts, verbose=False
    )
